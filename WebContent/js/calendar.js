...
function func(){
			var index1 = document.getElementById("test");
			index1.value=null;

		}
function func1(){

			var index2 = document.getElementById("text1");
			if(index2.value=="请输入3-8位英文或数字")
			index2.value=null;

		}
function func2(){
			var index4 = document.getElementById("text3");
			if(index4.value=="请输入3-8位英文或数字")
			index4.value=null;
		}
var cal;
...
{  
    var date = new Date();  
    var by = date.getFullYear()-30; //最小值 → 10 年前  
